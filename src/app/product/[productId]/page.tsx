    ...
    return (
        <MaxWidthWrapper className="bg-white">
                        ...
                        <section className="mt-4">
                            ...
                            <div className="mt-6 flex items-center">
                                <Check
                                    ...
                                    aria-hidden
                                />
                                <p className="ml-2 text-sm text-muted-foreground">Eligable for instance delivery</p>
                            </div>
                        </section>
                    </div>
                    ...
                    <div className="mt-10 lg:col-start-1 lg:row-span-2 lg:max-w-lg lg:self-start">
                        <div>
                            ...
                            <div className="mt-6 text-center">
                                <div className="group inline-flex text-sm text-md">
                                    <Shield
                                        aria-hidden={true}
                                        className="mr-2 h-5 w-5 flex-shrink-0 text-gray-400"
                                    />
                                    <span className="text-muted-foreground hover:text-gray-700">
                                        3- Day Return Guarantee
                                    </span>
                                </div>           
                            </div>
                        </div>
            ...
            <ProductReel
                ...
                title={`Similar ${label}`}
                subTitlle={`Browse similar high quality ${label} just like ${product.name}`}
            />
        </MaxWidthWrapper>
    );
}
