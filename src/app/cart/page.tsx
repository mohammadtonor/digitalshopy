...
const Paage = () => {
    const { items, remoeItem } = useCart();
    const router = useRouter();

    const { mutate: createCheckoutSession, isLoading} = trpc.peyment.createSession.useMutation({
        onSuccess: ({ url }) => {
    ...
    return ( 
        <div className="bg-white">
            <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                <h1 className="text-3xl font-bold mb-6 tracking-tight text-gray-900 sm:text-4xl">
                    Shoping Cart 
                </h1>

                <div className="ml-2 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-12">
                    <div className={cn('lg:col-span-7', {
                        'rounded-lg border-dashed border-zinc-200 p-12': isMounted && items.length === 0
                    })}>
                        ...
                        <ul
                            className={cn({
                                'divide-y divide-gray-200 border-b  border-t border-gray-300': 
                                isMounted && items.length > 0 
                            })}>
                                        ...
                                        <div className="ml-4 flex-1 flex-col justify-between sm:ml-6">
                                            <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                                ...
                                                <p className="mt-4 flex space-x-2 text-sm text-gray-700">
                                                    ...
                                                    <span>
                                                        Eigible for instance dellivery
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div className="mt-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                                <div className="flex items-center text-sm text-muted-foreground">
                                    <span>File Transaction fee</span>
                                </div>
                            ...
                            <div className="flex items-center pt-2 justify-between border-t border-gray-200">
