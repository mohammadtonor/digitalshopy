        ...
        <div className="group relative bg-zinc-100 aspect-square overflow-hidden rounded-xl">
            <div className="absolute z-10 inset-0 opacity-0 group-hover:opacity-100 transition">
                <button
                    ...
                    "hover:bg-primary-300 justify-center items-center text-primary-800 opacity-100": !slideConfig.isEnd
                })}
                ...
                <button
                    ...
                    className={cn(
                        ...
                        "lef-3 transition",
                        {
                            ...
                            "hover:bg-primary-300 justify-center items-center text-primary-800 opacity-100": !slideConfig.isBegining 
                        }
                    )}
                aria-label='next image'
